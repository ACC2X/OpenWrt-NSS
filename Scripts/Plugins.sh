...
#Design Theme
# git clone --depth=1 --single-branch --branch $(echo $OWRT_URL | grep -iq "lede" && echo "main" || echo "js") https://github.com/0x676e67/luci-theme-design.git
# git clone --depth=1 --single-branch https://github.com/0x676e67/luci-theme-design.git
